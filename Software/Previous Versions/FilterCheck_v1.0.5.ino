...
void reboot()
{
  ...
  analogWrite(fan_speed, 0);  // Set the PWM voltage to 0v
  digitalWrite(FAN_RELAY, LOW);  // Remove power from the Brushless Fan Blower
  delay(50);
  digitalWrite(GREEN_LED, HIGH);  // Turn on Green LED
  digitalWrite(BLUE_LED, HIGH);  // Turn on Blue LED
